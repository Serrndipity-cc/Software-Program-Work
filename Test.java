...
public class Test {
	...
	public  static  void register_account() {
		try {
		      String  pathname = "D:\\XUNLEIxiazai\\eclipse-java-2019-06-R-win32-x86_64\\eclipse\\workspace\\JAVA_Training\\src\\OnlineTeachingSystem\\User_Message.txt";
	...
	public  static void  write_file(List<Student>   student) {
		try {
		      String  pathname = "D:\\XUNLEIxiazai\\eclipse-java-2019-06-R-win32-x86_64\\eclipse\\workspace\\JAVA_Training\\src\\OnlineTeachingSystem\\Student_Message.txt";
		      File    file = new File(pathname);
		      if(!file.exists()) {       //要打开的文件夹不存在时，创建该文件夹
			      file.createNewFile();
		        }
